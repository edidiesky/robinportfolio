  ...
  return (
    <DeleteContainer className={productAlert ? "active" : ""}>
      <div className={productAlert ? "deleteCard active" : "deleteCard"}>
        <div className="cross" onClick={() => dispatch(clearProductAlert())}>
          <RxCross2 />
        </div>
        <div className="deleteCardTop">
          <h3>Delete Media?</h3>
        ...
        <div className="deleteCardBottom">
          <button onClick={() => dispatch(clearProductAlert())}>Cancel</button>
          <button
            className="deleteBtn"
            onClick={() => dispatch(adminDeleteProduct(productDetails?._id))}
          >
            Delete Product
          </button>
        </div>
